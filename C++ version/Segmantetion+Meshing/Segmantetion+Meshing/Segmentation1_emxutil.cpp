...
// Return Type  : void
//
void b_emxInit_int16_T(emxArray_int16_T **pEmxArray, int numDimensions)
{
...
// Return Type  : void
//
void b_emxInit_real32_T(emxArray_real32_T **pEmxArray, int numDimensions)
{
...
// Return Type  : void
//
void c_emxInit_boolean_T(emxArray_boolean_T **pEmxArray, int numDimensions)
{
  emxArray_boolean_T *emxArray;
  int i;
  *pEmxArray = (emxArray_boolean_T *)malloc(sizeof(emxArray_boolean_T));
